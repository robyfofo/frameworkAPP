...
--
-- Struttura della tabella `app130_invoices_sales`
--

CREATE TABLE `app130_invoices_sales` (
  `id` int(8) NOT NULL,
  ...
  `number_year` varchar(4) NOT NULL,
...
--
-- Indici per le tabelle `app130_invoices_sales`
--
ALTER TABLE `app130_invoices_sales`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT per la tabella `app130_invoices_sales`
--
ALTER TABLE `app130_invoices_sales`
