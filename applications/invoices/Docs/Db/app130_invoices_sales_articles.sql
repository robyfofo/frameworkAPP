...
--
-- Struttura della tabella `app130_invoices_sales_articles`
--

CREATE TABLE `app130_invoices_sales_articles` (
  `id` int(8) NOT NULL,
...
--
-- Indici per le tabelle `app130_invoices_sales_articles`
--
ALTER TABLE `app130_invoices_sales_articles`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT per la tabella `app130_invoices_sales_articles`
--
ALTER TABLE `app130_invoices_sales_articles`
